...
namespace Game
{
    class wEnemyRedDiamond : iWeapon
    {
        // Weapon stats
        private int ammo = 0;
        ...
        public WeaponTypes ThisType => WeaponTypes.Enemy2;
        ...
        public wEnemyRedDiamond() { this.recoilTime = ProyectileProperties.EnemyRedDiamond.Recoil; }
        ...
        public void Fire(string owner, Vector2 currentPosition)
        {
            if (canShoot)
            {
                ...
                var pEnemyRedDiamond = fyPoolDay.Pool.CreateProyectile(owner, newID);
                pEnemyRedDiamond.Awake(currentPosition, ThisType, GameManager.ProyectileDirection(currentPosition));
                canShoot = false;
            }
        }
